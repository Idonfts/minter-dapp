...
const p_public_mint = "⚠️Before confirming the transaction edit gas fee and set it to high⚠️";
...
const mint_failed = "Minting your NFT. Check MetaMask";
